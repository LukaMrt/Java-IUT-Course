package com.lukamaret.course.projetTP.seanceTD9;

import com.lukamaret.course.projetTP.seanceTD9.documents.CD;
import com.lukamaret.course.projetTP.seanceTD9.documents.DocBibliotheque;
import com.lukamaret.course.projetTP.seanceTD9.documents.DocURL;
import com.lukamaret.course.projetTP.seanceTD9.documents.Livre;
import com.lukamaret.course.projetTP.seanceTD9.membres.MembreBibliotheque;
import com.lukamaret.course.projetTP.seanceTD9.membres.MembreEtudiant;
import com.lukamaret.course.projetTP.seanceTD9.membres.MembrePersonnel;
...
public class Library {
    ...
    private static final CatalogueBibliotheque CATALOGUE = new CatalogueBibliotheque(new ArrayList<>());
    ...
    public static void main(String[] args) {
        ...
        CATALOGUE.add(new Livre("004. 178 K20PM", "Introduction à Java", "J. Leblanc", 2015, 12, "Bla bla", "aojcdcoj"));
        CATALOGUE.add(new CD("967. 4987 T248O", "Structures de Données", new ArrayList<>(List.of("M. Machin")), 2017, new ArrayList<>(List.of("M. Machin"))));
        CATALOGUE.add(new DocURL("967. 4447 TK48O", "Cours de C", "S. Dubard", 2020, "https://test.fr"));
        CATALOGUE.add(new Livre("117. 4937 UI489", "Etudes des algorithmes", "G. Lauriol", 2019, 12, "Bla bla", "aojcdcoj"));

        MEMBERS.addMember(new MembreEtudiant("John", "Doe", "1111111111", "1 rue de la paix"));
        MEMBERS.addMember(new MembrePersonnel("Bob", "Dupond", "2222222222", "2 rue de la paix"));
        MEMBERS.addMember(new MembrePersonnel("Tony", "blabla", "3333333333", "3 rue de la paix"));
        MEMBERS.addMember(new MembreEtudiant("Ed", "sheeeeesh", "4444444444", "4 rue de la paix"));
