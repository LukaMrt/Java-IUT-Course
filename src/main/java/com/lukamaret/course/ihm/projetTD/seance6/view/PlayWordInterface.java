...
import com.lukamaret.course.ihm.projetTD.seance6.action.CopyFromComboAction;
import com.lukamaret.course.ihm.projetTD.seance6.action.CopyToComboAction;
...
public class PlayWordInterface extends JFrame {
    ...
    public PlayWordInterface() {
        ...
        menuItem.addActionListener(e -> JOptionPane.showMessageDialog(this, "Auteur : Luka MARET"));
        menu.add(menuItem);
        menuBar.add(menu);
